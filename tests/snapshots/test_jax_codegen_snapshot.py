...
def test_jax_codegen_snapshot() -> None:
    ir = GraphIR(
        name="mlp",
        opset=18,
        tensors={
    ...
    assert_snapshot("jax_mlp.py", code, test_file=__file__)


def test_jax_codegen_qwen_ops_snapshot() -> None:
    ir = GraphIR(
        name="qwen_ops",
        opset=18,
        tensors={
    ...
    code = render_jax_module(ir)
    assert_snapshot("jax_qwen_ops.py", code, test_file=__file__)


def test_jax_codegen_qwen_fused_decoder_ops_snapshot() -> None:
    ir = GraphIR(
    ...
    code = render_jax_module(ir)
    assert_snapshot("jax_qwen_fused_decoder_ops.py", code, test_file=__file__)
